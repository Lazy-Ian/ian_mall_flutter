...
class HomeRecActModel extends Object {
  ...
  factory HomeRecActModel.fromJson(Map<String, dynamic> srcJson) =>
      _$HomeRecActModelFromJson(srcJson);
...
class ActModelList extends Object {
  List<HomeActProductListModel> product_list;
  ...
  factory ActModelList.fromJson(Map<String, dynamic> srcJson) =>
      _$ActModelListFromJson(srcJson);
