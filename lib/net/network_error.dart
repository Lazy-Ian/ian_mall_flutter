...
class NetError extends Error {
  ...
  NetError._init(this.status, {required this.message});

  factory NetError.excetpion(Exception exception,
      {int? status, String? message}) {
    int? code = status;
    String msg = message ?? errorCode[exception.value] as String;
    return NetError._init(code, message: msg);
  }
}

Map<int, Tuple> errorCode = {
